...
require 'C:\wamp64\www\fame\back-20190723T124736Z-001\back\phpmailer\vendor\autoload.php';
    ...
    try {
        ...
        $mail->Subject = 'RECLAMATION ACCEPTEE';
		$mail->isHTML(TRUE);
        $mail->Body = "<html><h1 style='background-color:gold;color:green;text-align:center'>VOTRE RECLAMATION A ETE ACCEPTE</h1><p style='text-align:center;color:white;background-color:slategray;'>Votre reclamation a été prise en compte nous vous tiendrons au courant de l'avancée de son traitement ... Fameink vous remerci pour votre confiance. Faites des achats et debloquez votre compte de fidelite pour beneficier des reductions et d'autres avantages liés a votre compte. </p></html>";
        $mail->isSMTP();
        $mail->Port = 587;
        $mail->SMTPAuth = TRUE;
        $mail->SMTPSecure = 'tls';
