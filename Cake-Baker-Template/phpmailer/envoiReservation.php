...
require 'C:\wamp64\www\laCaverne\phpmailer\vendor\autoload.php';
    ...
    try {
        ...
        $mail->Body = "
		<html>
		<h1 style='background-color:gold;color:gray;text-align:center'>RESERVATION ENVOYE</h1>
		<p style='text-align:center;color:white;background-color:slategray;'>
		Votre reservation a ete envoye avec succes, nous vous contacterons dans les plus brefs delais pour confirmer votre reservation en fonction des disponibilites.
        </p>
		</br>
        <p style='text-align:center;color:white;background-color:slategray;'>
		La Caverne a gouter vous remerci pour votre confiance. Faites des achats pour pouvoir beneficier des reductions et d'autres avantages liés a votre compte. 
		</p>
		</html>";
        $mail->isSMTP();
        $mail->Port = 587;
